...
zooAnimals.forEach((zooAnimal) => {
  animalNames.push(zooAnimal.animal_name + " " + zooAnimal.scientific_name); //added the extra space to give it some space in between
});
...
*/
const lowerCase = zooAnimals.map((animalNames) => {
  return animalNames.animal_name.toLowerCase();   //added toLowerCase 
})
